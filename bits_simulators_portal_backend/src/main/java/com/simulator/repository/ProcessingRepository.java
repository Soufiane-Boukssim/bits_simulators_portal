...
*/
    ...
    @Query("SELECT pd FROM ProcessingDef pd WHERE pd.id.procProtocol = :protocol AND pd.id.bankCode = :bankCode")
    List<ProcessingDef> findByProtocolAndBankCode(@Param("protocol") String protocol, @Param("bankCode") String bankCode);
}
