...
public interface AccountRepository extends JpaRepository<AccountDef , AccountDefId> {
    ...
    List<AccountDef> findByBankCodeAndAccProtocol(@Param("bankCode") String bankCode, @Param("accProtocol") String accProtocol);
/*
    List<AccountDef> findById_BankCodeAndId_AccProtocol(String bankCode, Character accProtocol);
*/
