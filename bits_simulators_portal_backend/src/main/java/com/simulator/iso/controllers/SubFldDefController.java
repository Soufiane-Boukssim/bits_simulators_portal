...
public class SubFldDefController {
    ...
    public ResponseApiJson<List<SubfldDefinition>> getSubfldDefinitionsByProtocols(@RequestBody SubfldDefinitionId id) {
        logger.info("#################### Star getSubfldDefinitionsByProtocols ####################");
        ResponseApiJson<List<SubfldDefinition>> responseApiJson = subFldDefService.getSubfldDefinitionsByProtocols(id);
        return responseApiJson;
    }
