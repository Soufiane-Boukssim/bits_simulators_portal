...
@Service
@AllArgsConstructor
public class HandleSpecialValuesMasterCard {
    private final Logger logger = LogManager.getLogger(HandleSpecialValuesMasterCard.class);
    ...
    public String handleSpecialValues(String value, String fieldNumber, String field11, CasesDefinition casesDefinition ,String userCode) throws Exception {
        ...
        switch (value){
            case "Generate Value" :
                value = handleGenerateValue(fieldNumber, casesDefinition, field11);
                break;
    ...
    private String handleGenerateValue(String fieldNumber, CasesDefinition casesDefinition, String field11) throws InterruptedException {
        Date date = new Date();
