...
public class UserHabilitationParam {
    ...
    // 02.02.2024 HAMZA
    @Column(name = "PROTOCOL_CODE", nullable = true)
    private String protocolCode;

    public UserHabilitationParam(int userHabilitationId, String habilitationCode, String userCode, Date startDate, Date endDate, char typeRole, String protocolCode) {
