...
@NoArgsConstructor
@AllArgsConstructor
public class PosCasesDefinitionId implements Serializable {
    @Serial
    ...
    public PosCasesDefinitionId(String caseNo, String caseProtocole) {
        this.caseNo = caseNo;
        this.caseProtocole = caseProtocole;
    }

    public PosCasesDefinitionId(String caseNo, String caseProtocole, Character caseType) {
        this.caseNo = caseNo;
        this.caseProtocole = caseProtocole;
