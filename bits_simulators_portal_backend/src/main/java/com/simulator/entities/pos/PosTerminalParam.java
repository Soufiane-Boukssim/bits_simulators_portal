...
@Entity
@Data
@Table(name = "pos_terminal_param")
public class PosTerminalParam {

    @EmbeddedId
    private PosTerminalParamId id;
    ...
    @Column(name="term_type",length =4 )
    ...
    public PosTerminalParamId getId() {
        return id;
    }

    public void setId(PosTerminalParamId id) {
        this.id = id;
    }
    ...
    public PosTerminalParam(PosTerminalParamId id, String termLocation, String termCapabilities, String termType, int tranCount, String termVerResult, String applicationVerNum) {
        this.id = id;
        this.termLocation = termLocation;
        this.termCapabilities = termCapabilities;
        this.termType = termType;
