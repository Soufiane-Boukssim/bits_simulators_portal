...
@Embeddable
@Data
public class PosIccProfileId implements Serializable {
    ...
    @Column(name = "ICC_PROTOCOL",length = 2)
    private String iccProtocol;

    @Column(name = "BANK_CODE", length = 5)
    private String bankCode;

    public PosIccProfileId(String icPrf, String icTag) {
        this.icPrf = icPrf;
        this.icTag = icTag;
    }

    public PosIccProfileId() {
    }
