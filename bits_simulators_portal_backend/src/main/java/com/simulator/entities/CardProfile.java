...
public class CardProfile {
    ...
    public CardProfile(CardProfileWithIccModel cardProfileWithIccModel) {
        this.id = new CardProfileId(cardProfileWithIccModel.getId().getCardNo(),cardProfileWithIccModel.getId().getCardProtocol(),cardProfileWithIccModel.getId().getBankCode());
