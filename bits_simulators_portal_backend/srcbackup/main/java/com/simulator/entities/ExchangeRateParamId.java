...
@Embeddable
public class ExchangeRateParamId implements Serializable {
    ...
    @Column(name = "RATE_PROTOCOL",length = 1)
   ...
   /* public String getRateProtocol() {
    ...
    public ExchangeRateParamId(String baseCcy, String rateProtocol ,String rateStartDate, String currCode) {
        this.baseCcy = baseCcy;
        this.rateStartDate = rateStartDate;
        this.currCode = currCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExchangeRateParamId entity = (ExchangeRateParamId) o;
