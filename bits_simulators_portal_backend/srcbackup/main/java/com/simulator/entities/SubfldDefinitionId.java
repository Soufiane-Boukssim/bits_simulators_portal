...
public class SubfldDefinitionId implements Serializable {
    ...
    @Column(name = "SUBFLD_PROTOCOLE",length = 1)
    private Character subfldProtocole;

    @Column(name = "BANK_CODE", length = 5)
    private String bankCode;

    public SubfldDefinitionId(String subfldId, Character subfldProtocole) {
    ...
    public Character getSubfldProtocole() {
        return subfldProtocole;
    }

    public void setSubfldProtocole(Character subfldProtocole) {
        this.subfldProtocole = subfldProtocole;
    }
