...
class MerchantController {
    ...
    public ResponseEntity<MerchantParam> getMerchantParam(@RequestBody MerchantParamId id) {
        try {
            logger.info("test 1");
            MerchantParam merchantParam = merchantService.getMerchantParam(id);
   ...
   /* @SecurityRequirement(name = "Bearer Authentication")
    ...
    public   List<MerchantParam> getFilteredMerchantList(
        ...
        return merchantService.getFilteredMerchantList(id.getBankCode(), id.getMerProtocol());
    }

   /* @SecurityRequirement(name = "Bearer Authentication")
    @PostMapping("/getAllMerchantParams")
    public ResponseApiJson<List<MerchantParam>> getAllMerchantParam() {
        logger.info("#################### Star getAllMerchantParams ####################");
        ResponseApiJson<List<MerchantParam>> responseApiJson = merchantService.getAllMerchantParams();
