...
public class TerminalController {
    ...
    public ResponseEntity<TerminalParam> getTerminalParam(@RequestBody TerminalParamId id) {
        try {
            logger.info("test 1");
            TerminalParam terminalParam = terminalService.getTerminalParam(id);
   ...
   /* @SecurityRequirement(name = "Bearer Authentication")
    ...
    public   List<TerminalParam> getFilteredTerminalList(
        ...
        return terminalService.getFilteredTerminalList(id.getBankCode(), id.getTerProtocol());
    }

  /*  @SecurityRequirement(name = "Bearer Authentication")
    @PostMapping("/getAllTerminalParams")
    public ResponseApiJson<List<TerminalParam>> getAllTerminalParam() {
        logger.info("#################### Star getAllTerminalParams ####################");
        ResponseApiJson<List<TerminalParam>> responseApiJson = terminalService.getAllTerminalParams();
