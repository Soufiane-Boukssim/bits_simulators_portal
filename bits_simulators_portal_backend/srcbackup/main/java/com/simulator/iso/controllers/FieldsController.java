...
public class FieldsController {
    ...
    public ResponseEntity<FieldsDefinition> getFieldsDefinition(@RequestBody FieldsDefinitionId id) {
        try {
            logger.info("test 1");
            FieldsDefinition fieldsDefinition = fieldsService.getFieldsDefinition(id);
...
*/
    ...
    public ResponseApiJson<List<FieldsDefinition>> getAllFieldsDefinition() {
        logger.info("#################### Star getAllFieldsDefinitions ####################");
        ResponseApiJson<List<FieldsDefinition>> responseApiJson = fieldsService.getAllFieldsDefinitions();
