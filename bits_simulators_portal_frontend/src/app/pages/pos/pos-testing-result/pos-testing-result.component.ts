...
@Component({
  selector: 'app-pos-testing-result',
  templateUrl: './pos-testing-result.component.html',
  styleUrls: ['./pos-testing-result.component.scss']
})



export class PosTestingResultComponent {
  tab_1: boolean = true
  tab_2: boolean = false
  tab_3: boolean = false
  ...
  getMessages() {
    ...
    this.globalService.getMessagesPOS(id).subscribe(response => {
  ...
  selectTransaction(row: any) {
    ...
    let bodyRes = {
      ...
      this.globalService.getSidDumpPos(bodyReq).subscribe((data) => {
      ...
      this.globalService.SidMsgHexTracePos(bodyReq).subscribe((data) => {
      ...
      this.globalService.getSidDumpPos(bodyRes).subscribe((data) => {
        const resultObj = JSON.parse(data.result);
        const fields = resultObj.fields;
        // // console.log('Parsed fields:', fields);
      ...
      this.globalService.SidMsgHexTracePos(bodyRes).subscribe((data) => {
        // console.log('data: ', data);
