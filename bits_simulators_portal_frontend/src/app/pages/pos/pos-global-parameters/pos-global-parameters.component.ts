...
@Component({
  selector: 'app-pos-global-parameters',
  templateUrl: './pos-global-parameters.component.html',
  styleUrls: ['./pos-global-parameters.component.scss']
})



export class PosGlobalParametersComponent {
  protocol: string = "PO";
  language: string = "";
  bankCode: any = "";
  ...
  getCommunicationParam() {
    ...
    // console.log('id: ', id);
    this.globalService.getOneCommunicationParamPOS(id).subscribe((response) => {
      // console.log('response: ', response);
  ...
  if (this.isDelete) {
    this.globalService.updateCommunicationParamPOS(formData).subscribe((response) => {
     this.closemodal()
      // console.log('response://// ', response);
      if (response.respCode == '000') {
    ...
    this.closemodal()
    this.globalService.addCommunicationParamPOS(formData).subscribe((response) => {
      if (response.respCode == '000') {
        this.communicationForm.reset();
        this.getCommunicationParam();
  ...
  //   });
  // }
  this.globalService.deleteCommunicationParamPOS(this.communicationForm.value.id).subscribe((response) => {
    this.closemodal();
    if (response.respCode == "000") {
      this.clearAll()
  ...
  getInstitutionParam() {
    ...
    // console.log('id: ', id);
    this.globalService.getOneInstitutionParamPOS(id).subscribe((response) => {
      // console.log('response: ', response);
  ...
  this.globalService.deleteInstitutionParamPOS(this.instForm.value.id).subscribe((response) => {
    this.closemodal();
    if (response.respCode == "000") {
      this.clearAll();
  ...
  if (this.isDelete) {
    this.globalService.updateInstitutionParamPOS(this.instForm.value).subscribe((response) => {
     this.closemodal()
      // console.log('response://// ', response);
      if (response.respCode == '000') {
        this.instForm.reset();
    ...
    this.closemodal()
    this.globalService.addInstitutionParamPOS(this.instForm.value).subscribe((response) => {
      if (response.respCode == '000') {
        this.instForm.reset();
        this.getInstitutionParam()
