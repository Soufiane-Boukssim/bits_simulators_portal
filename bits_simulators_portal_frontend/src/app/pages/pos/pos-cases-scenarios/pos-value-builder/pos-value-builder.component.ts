...
import { PosFieldProcessingService } from 'src/app/services/pos-field-processing.service';

@Component({
  selector: 'app-pos-value-builder',
  templateUrl: './pos-value-builder.component.html',
  styleUrls: ['./pos-value-builder.component.scss']
})


export class PosValueBuilderComponent implements OnChanges,OnInit {
