...
@Component({
  selector: 'app-parameteroptions',
  templateUrl: './parameteroptions.component.html',
  styleUrls: ['./parameteroptions.component.scss']
})
export class ParameteroptionsComponent {
