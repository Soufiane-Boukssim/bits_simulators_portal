...
@Component({
  selector: 'app-value-definer',
  templateUrl: './value-definer.component.html',
  styleUrls: ['./value-definer.component.scss']
})
export class ValueDefinerComponent implements OnChanges  ,OnInit {
