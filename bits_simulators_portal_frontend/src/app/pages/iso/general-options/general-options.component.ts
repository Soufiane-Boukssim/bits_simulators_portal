...
item: any;
  ...
  getTagList() {
    ...
    this.globalService.fetchTagByProtocol(body).subscribe(response => {
...
getFields(){
  ...
  this.globalService.getFields(body).subscribe(response => {
  ...
  getFunctionList() {
    ...
    this.globalService.fetchFunctionByProtocol(body).subscribe(response => {
  ...
  getProcessingList() {
    ...
    this.globalService.fetchProcessingByProtocol(body).subscribe(response => {
      // console.log('response: ', response);
      if (response.result.length > 0) {
