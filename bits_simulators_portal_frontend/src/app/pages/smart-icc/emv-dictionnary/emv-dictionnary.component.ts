...
@Component({
  selector: 'app-emv-dictionnary',
  templateUrl: './emv-dictionnary.component.html',
  styleUrls: ['./emv-dictionnary.component.scss']
})
export class EmvDictionnaryComponent implements OnInit {
  ...
  constructor(private globalService: GlobalService, private emvTagService: EmvTagServiceService) {
    this.globalService.titleSubject.next("EMV Dictionary")
  }
