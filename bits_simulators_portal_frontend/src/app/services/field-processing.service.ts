...
export class FieldProcessingService {
  constructor(private http: HttpClient) {
  }

  retrieveSubFields(fieldId: string,body:any): Observable<any> {
      ...
      .pipe(
        map((data: any) => {
          ...
          if (data.respCode === "000") {
            ...
            // console.log("filteredSubFields",filteredSubFields);
  ...
  //   this.http.post(baseUrl + '/su/subFldDef/getAllSubfldDefinitions', {}).subscribe({
  //     next: (data: any) => {
  //       // console.log("----------- sub fields ------------");
  //       // console.log(data);
  //       // console.log("----------- sub fields ------------");
